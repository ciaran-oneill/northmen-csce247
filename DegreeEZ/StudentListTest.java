...
public class StudentListTest {
    ...
    public void setup() throws IOException {
        ...
        students.add(new Student(UUID.randomUUID(), "ASmith", "Amanda", "asmith", "password", 1, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), null));
    ...
    void testGetStudents() {
        ...
        assertTrue(areEqual(students.get(0), StudentList.getStudentByUUID(id1)), "The first student should be returned by calling the 'getStudentByUUID' with id1.");
        assertTrue(areEqual(students.get(1), StudentList.getStudentByUUID(id2)), "The second student should be returned by calling the 'getStudentByUUID' with id2.");
    }
